...
import com.mrkaz.tokoin.presentation.ui.register.RegisterFragment
...
class RegisterFragmentTest : BaseUITest() {
    ...
    fun start() {
        ...
        launchFragment<RegisterFragment>(themeResId = R.style.AppTheme).let {
    ...
    @Test
    fun test_register_with_empty_username() {
        //Arrange
    ...
    @Test
    fun test_register_with_empty_password() {
        //Arrange
        onView(withId(R.id.tietUserName))
    ...
    @Test
    fun test_register_duplicated(): Unit = runBlocking {
        //Arrange
    ...
    @Test
    fun test_register_(): Unit = runBlocking {
        //Arrange
        onView(withId(R.id.tietUserName))
            .perform(typeText("binhh445"))
        onView(withId(R.id.tietPassword))
            .perform(typeText("123"))
        onView(withId(R.id.btnRegister)).perform(click())
        //Assert
